...
const Projects = () => {
  ...
  return (
    <div className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
        ...
        <p className='text-center text-grey-500 mb-8 max-w-80 mx-auto'>Crafting Spaces, Building Legaciees-Explore Our Portfolio</p>
        ...
        <div className='overflow-hidden'>
          <div className='flex gap-8 transition-transform duruation-500 ease-in-out' style={{transform: `translateX(-${(currentIndex * 100) / cardsToShow}%)`}}>
