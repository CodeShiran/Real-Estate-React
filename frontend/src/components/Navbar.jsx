...
const Navbar = () => {
    ...
    const [showMovileMenu, setShowMobileMenu] = useState(false)
  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10'>
        <div className='contaier mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent'>
        ...
        {/*mobile menu*/}
        <div className={`md:hidden ${showMovileMenu ? 'fixed w-full' : 'h-0 w-0' }  right-0 top-0 bottom-0 overflow-hidden bg-white transition-all`}>
